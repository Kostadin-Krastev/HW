...
console.log(
  `The youngest student is ${youngestStudent[2]} ${youngestStudent[3]}. He is ${youngestStudent[1]} years old.`
);
...
////////////////////////////////////////////////
// your code goes here:
// initialize maxAge with first student age:
let maxAge = students[0][1];
// variable to store oldest student data:
let oldestStudent;

for (let x = 0; x < students.length; x++) {
  const studentAge = students[x][1];

  if (studentAge >= maxAge) {
    maxAge = studentAge;
    oldestStudent = students[x];
  }
}
